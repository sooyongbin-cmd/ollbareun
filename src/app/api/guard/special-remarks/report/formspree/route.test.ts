...
describe("POST /api/guard/special-remarks/report/formspree", () => {
  ...
  it("creates a special remark report through Formspree", async () => {
    ...
    const response = await POST(
      new Request("http://localhost/api/guard/special-remarks/report/formspree", {
        method: "POST",
    ...
    expect(createSpecialRemarkReport).toHaveBeenCalledWith(body, { emailProvider: "formspree" });
  });
});
