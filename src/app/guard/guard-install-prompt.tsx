  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[100] px-4 pb-4 sm:pb-6" role="dialog" aria-labelledby="guard-install-title">
      <div className="mx-auto flex w-full max-w-[600px] items-center gap-4 rounded-xl border border-border bg-background p-4 shadow-lg">
        ...
        <img className="h-12 w-12 shrink-0 rounded-[14px]" src="/guard-icon-192.png" alt="" width={48} height={48} />
        <div className="min-w-0 flex-1">
          <h2 id="guard-install-title" className="text-[17px] font-semibold text-foreground">
            올바름 현장 근로자 설치
          </h2>
          <p className="mt-1 text-[13px] leading-5 text-muted-foreground">휴대폰 홈 화면에 아이콘을 추가합니다.</p>
        </div>
