...
import { useHomepageCompanyAddress, useHomepageMapCoordinates } from "./homepage-company-address";
...
function ContactSection() {
  ...
  const mapCoordinates = useHomepageMapCoordinates();

  return (
    <section id="contact" className={`${styles.section} ${styles.contactSection}`}>
      <div className={styles.contactInner}>
        <HomepageContactMap address={companyAddress} coordinates={mapCoordinates} />
            ...
            description={
              <>
                ...
                <span className={styles.mobileOnlyCopy}>
                  올바름은 취약계층에게 안정된 일자리를 제공하고,
                  <br />
                  균등한 교육기회와 복리후생을 통해 직무에 전념할
                  <br className={styles.socialMobileReflowBreak} />{" "}
                  수 있는
                  <br className={styles.socialMobileDefaultBreak} />{" "}
                  환경을 만듭니다. 지역사회 재투자와
                  <br className={styles.socialMobileReflowBreak} />{" "}
                  사회서비스 확충을
                  <br className={styles.socialMobileDefaultBreak} />{" "}
    ...
    <main id="top" className={`${styles.site} ${styles.servicesPage}`}>
      ...
      <section id="dispatch" className={`${styles.section} ${styles.detailSection} ${styles.dispatchSection}`}>
        <div className={styles.serviceSectionInner}>
          ...
          <h3 className={styles.detailMessage}>사무관리, 생산·물류, IT·전산, 의료·간병, 콜센터 등{" "}<br className={styles.dispatchDesktopBreak} />필요한 직무에 적합한{" "}<br className={styles.dispatchMobileBreak} />인력을 연결합니다.</h3>
      ...
      <section id="disinfection" className={`${styles.section} ${styles.detailSection} ${styles.disinfectionSection}`}>
        <div className={styles.serviceSectionInner}>
          ...
          <h3 className={styles.detailMessage}>현장 조건에 맞춘 법정·살충·살균 소독으로<br />대형 건축물과 항공기 검역 현장의{" "}<br className={styles.disinfectionMobileBreak} />예방 체계를{" "}<br className={styles.mobileOnlyBreak} />지원합니다.</h3>
