...
describe("homepage Figma typography", () => {
  ...
  it("matches the Figma about-page body typography", () => {
    expect(stylesheet).toMatch(/\.aboutPage \.aboutHero h1\s*\{[^}]*font-size: 53px;[^}]*line-height: normal;/s);
    expect(stylesheet).toMatch(/\.aboutPage \.companySection \.sectionHeading h2,[\s\S]*font-size: 43px;[^}]*line-height: normal;/s);
    ...
    expect(stylesheet).toMatch(/\.aboutPage \.contactCopy h2\s*\{[^}]*font-size: 43px;[^}]*line-height: normal;/s);
  });

  it("matches the Figma services-page body typography", () => {
    expect(stylesheet).toMatch(/\.servicesPage \.serviceHero h1\s*\{[^}]*font-size: 53px;[^}]*line-height: normal;/s);
    ...
    expect(stylesheet).toMatch(/\.servicesPage \.sectionHeading > span\s*\{[^}]*font-size: 21px;[^}]*line-height: normal;/s);
    expect(stylesheet).toMatch(/\.servicesPage \.operationLayout > h3\s*\{[^}]*font-size: 47\.17px;[^}]*line-height: normal;/s);
    expect(stylesheet).toMatch(/\.servicesPage \.detailMessage\s*\{[^}]*font-size: 35px;[^}]*line-height: normal;/s);
    expect(stylesheet).toMatch(/\.servicesPage \.facilityGrid h3\s*\{[^}]*font-size: 25\.78px;[^}]*line-height: normal;/s);
    expect(stylesheet).toMatch(/\.servicesPage \.facilityGrid p\s*\{[^}]*font-size: 19\.64px;[^}]*line-height: normal;/s);
  ...
  it("matches the Figma clients-page body typography", () => {
    expect(stylesheet).toMatch(/\.clientsPage \.clientHero h1\s*\{[^}]*font-size: 53px;[^}]*line-height: normal;/s);
    ...
    expect(stylesheet).toMatch(/\.clientsPage \.sectionHeading > span\s*\{[^}]*font-size: 21px;[^}]*line-height: normal;/s);
