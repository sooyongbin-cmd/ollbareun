...
describe("education completions detail page", () => {
  beforeEach(() => {
    vi.restoreAllMocks();
    window.history.replaceState(null, "", "/manager/safety/completions/detail");
    vi.stubGlobal(
      "fetch",
  ...
  it("filters education completions by resource id from the url", async () => {
    window.history.replaceState(null, "", "/manager/safety/completions/detail?resourceId=resource-2");
  ...
  it("filters education completions by employee name from the url", async () => {
    window.history.replaceState(null, "", "/manager/safety/completions/detail?name=%EC%9D%B4%EC%88%9C%EC%8B%A0");
