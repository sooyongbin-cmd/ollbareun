  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[100] px-4 pb-4 sm:pb-6" role="dialog" aria-labelledby="manager-install-title">
      <div className="mx-auto flex w-full max-w-[37.5rem] items-center gap-4 rounded-xl border border-border bg-background p-4 shadow-lg">
        ...
        <img className="h-12 w-12 shrink-0 rounded-[0.875rem]" src="/manager-icon-192.png" alt="" width={48} height={48} />
        <div className="min-w-0 flex-1">
          <h2 id="manager-install-title" className="text-[1.0625rem] font-semibold text-foreground">
            올바름 관리자 설치
          </h2>
          <p className="mt-1 text-[0.8125rem] leading-5 text-muted-foreground">휴대폰 홈 화면에 관리자 아이콘을 추가합니다.</p>
        </div>
