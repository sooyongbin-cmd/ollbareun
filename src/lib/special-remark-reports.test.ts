...
describe("special remark report Formspree delivery", () => {
  ...
  it("stores the report and sends the email through Formspree", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith(
      "https://formspree.io/f/mojzkwbp",
      expect.objectContaining({
        body: expect.stringContaining("https://example.supabase.co/storage/v1/object/public/special-remarks/employee-1/photo.jpg"),
      }),
    );
